...
async function main() {
   ...
   const GZA_CHEF_ADDR = "0xE9a9EeE33761954031284422E9b71266b45f16E1";
   const rewardTokenTicker = "GZA";
   const GZA_CHEF = new ethers.Contract(GZA_CHEF_ADDR, GZA_CHEF_ABI, App.provider);

   const startBlock = await GZA_CHEF.startBlock();
   const currentBlock = await App.provider.getBlockNumber();

   const multiplier = await GZA_CHEF.getMultiplier(currentBlock, currentBlock + 1);
   ...
   if(currentBlock < startBlock){
    ...
    await loadMaticChefContract(App, tokens, prices, GZA_CHEF, GZA_CHEF_ADDR, GZA_CHEF_ABI, rewardTokenTicker,
        "gza", null, rewardsPerWeek, "pendingGza");
