...
async function main() {
   ...
   const UNIRON_CHEF_ADDR = "0xfC20DF587485748B6F1F764de50D5cE92908D271";

   const rewardTokenTicker = "UNIRON";
   const UNIRON_CHEF = new ethers.Contract(UNIRON_CHEF_ADDR, UNIRON_CHEF_ABI, App.provider);

   let rewardsPerWeek = 0
   const startBlock = await UNIRON_CHEF.startBlock();
   ...
   if(currentBlock < startBlock){
    ...
    rewardsPerWeek = await UNIRON_CHEF.UnironPerBlock() /1e18 * 604800;
   }
