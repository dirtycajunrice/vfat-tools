...
$(function() {
    ...
    async function main() {
       ...
       const APOLLO_CHEF_ADDR = "0xceD23FaA61f45C33a9d74b51e9DA776B88fB4Af8";
       const rewardTokenTicker = "APOLLO";
       const APOLLO_CHEF = new ethers.Contract(APOLLO_CHEF_ADDR, APOLLO_CHEF_ABI, App.provider);
        
       const blocksPerSeconds = await getAverageBlockTime(App);
       const startBlock = await APOLLO_CHEF.startBlock();
        const currentBlock = await App.provider.getBlockNumber();
           ...
           if(currentBlock < startBlock){
            ...
            rewardsPerWeek = await APOLLO_CHEF.apolloPerBlock() / 1e18 *		
