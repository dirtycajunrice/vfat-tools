...
async function main() {
    ...
    const BALLZ_CHEF_ADDR = "0x8fd027D88bd83C2Dd6EEA36a99ed349BC96d5CB4";
    const rewardTokenTicker = "BALLZ";
    const BALLZ_CHEF = new ethers.Contract(BALLZ_CHEF_ADDR, BALLZ_CHEF_ABI, App.provider);

    const startBlock = await BALLZ_CHEF.startBlock();
    ...
    if (currentBlock < startBlock) {
        ...
        rewardsPerWeek = await BALLZ_CHEF.ballzPerBlock() / 1e18 *
            604800 / 2.0;
    }
