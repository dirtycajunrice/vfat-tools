...
async function main() {
   ...
   const KRILL_CHEF_ADDR = "0x34bc3D36845d8A7cA6964261FbD28737d0d6510f";
   const rewardTokenTicker = "DB";
   const KRILL_CHEF = new ethers.Contract(KRILL_CHEF_ADDR, KRILL_CHEF_ABI, App.provider);

   const startBlock = await KRILL_CHEF.startBlock();
   ...
   if(currentBlock < startBlock){
    ...
    await loadMaticChefContract(App, tokens, prices, KRILL_CHEF, KRILL_CHEF_ADDR, KRILL_CHEF_ABI, rewardTokenTicker,
        "krill", null, rewardsPerWeek, "pendingKrill");
