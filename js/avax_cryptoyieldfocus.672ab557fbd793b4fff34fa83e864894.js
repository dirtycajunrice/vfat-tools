...
$(function () {		
    ...
    async function main() {		
        ...
        const CYF_CHEF_ADDR = "0xaB0141F81b3129f03996D0679b81C07F6A24c435";		
        const rewardTokenTicker = "CYF";		
        const CYF_CHEF = new ethers.Contract(CYF_CHEF_ADDR, CYF_CHEF_ABI, App.provider);		

        const blocksPerSeconds = await getAverageBlockTime(App);
    		
        const rewardsPerWeek = await CYF_CHEF.cyfPerBlock() / 1e18 *		
        ...
        await loadAvaxChefContract(App, tokens, prices, CYF_CHEF, CYF_CHEF_ADDR, CYF_CHEF_ABI, rewardTokenTicker,		
            "cyf", null, rewardsPerWeek, "pendingCyf");		
