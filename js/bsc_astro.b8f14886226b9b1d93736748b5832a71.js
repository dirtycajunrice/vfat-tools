...
async function main() {
   ...
   const ASTRO_CHEF_ADDR = "0xaa2f8F20A93Cc4b3895336C9E5d4ecEc9DE48599";
   ...
   if(currentBlock < startBlock){
    ...
    rewardsPerWeek = await ASTRO_CHEF.eggPerBlock() /1e18
        * 604800 / 3;
   }
    ...
    await loadBscChefContract(App, tokens, prices, ASTRO_CHEF, ASTRO_CHEF_ADDR, ASTRO_CHEF_ABI, rewardTokenTicker,
