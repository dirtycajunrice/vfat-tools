...
async function main() {
   ...
   const multiplier = await KIWI_CHEF.getMultiplier(currentBlock, currentBlock + 1);
   ...
   if(currentBlock < startBlock){
    ...
    await loadMaticChefContract(App, tokens, prices, KIWI_CHEF, KIWI_CHEF_ADDR, KIWI_CHEF_ABI, rewardTokenTicker,
