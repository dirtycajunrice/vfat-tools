...
async function main() {
   ...
   const MOCHI_CHEF_ADDR = "0xFdc8bbBb76f5d0c99aFF7fc7e0e58Bd9058701fB";
   const rewardTokenTicker = "aMOCHI";
   ...
   const rewardsPerWeek = await MOCHI_CHEF.mochiPerBlock() /1e18
    ...
    await loadAvaxChefContract(App, tokens, prices, MOCHI_CHEF, MOCHI_CHEF_ADDR, MOCHI_CHEF_ABI, rewardTokenTicker,
        "mochi", null, rewardsPerWeek, "pendingMochi", [5,9,11]);
