...
async function main() {
   ...
   const SILVER_CHEF_ADDR = "0x60938314756b0a9EeEa51731Ef8D1c10DB798D67";
   ...
   const multiplier = await SILVER_CHEF.getMultiplier(currentBlock, currentBlock+1);
   ...
   if(currentBlock < startBlock){
    ...
    await loadBscChefContract(App, tokens, prices, SILVER_CHEF, SILVER_CHEF_ADDR, SILVER_CHEF_ABI, rewardTokenTicker,
