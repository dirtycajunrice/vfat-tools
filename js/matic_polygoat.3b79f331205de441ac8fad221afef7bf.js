...
async function main() {
   ...
   const GOAT_CHEF_ADDR = "0xdf89fF7589Bda33FD04d92ce7be739A84DC72560";
   const rewardTokenTicker = "GOAT";
   const GOAT_CHEF = new ethers.Contract(GOAT_CHEF_ADDR, GOAT_CHEF_ABI, App.provider);

   const startBlock = await GOAT_CHEF.startBlock();
   ...
   if(currentBlock < startBlock){
    ...
    rewardsPerWeek = await GOAT_CHEF.GoatPerBlock() /1e18
      * 604800 / 2.1;
   }
    ...
    await loadMaticChefContract(App, tokens, prices, GOAT_CHEF, GOAT_CHEF_ADDR, GOAT_CHEF_ABI, rewardTokenTicker,
