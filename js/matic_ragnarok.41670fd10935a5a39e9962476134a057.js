...
async function main() {
    ...
    const RAGNAROK_CHEF_ADDR = "0x21AE833b7256daD6aFA1B7d5d952De19e223b394";
    const rewardTokenTicker = "RAGNAROK";
    const RAGNAROK_CHEF = new ethers.Contract(RAGNAROK_CHEF_ADDR, RAGNAROK_CHEF_ABI, App.provider);
    ...
    if (currentBlock < startBlock) {
        ...
        rewardsPerWeek = await RAGNAROK_CHEF.ragnarokPerBlock() / 1e18 *
            604800 / 2.1;
    }
    ...
    await loadMaticChefContract(App, tokens, prices, RAGNAROK_CHEF, RAGNAROK_CHEF_ADDR, RAGNAROK_CHEF_ABI, rewardTokenTicker,
        "ragnarok", null, rewardsPerWeek, "pendingRagnarok");
