...
$(function() {
    ...
    async function main() {
       ...
       const York_CHEF_ADDR = "0xF23053191FcA049f04926dBb108F86Cc61A4F77D";
       const rewardTokenTicker = "YORK";
       const York_CHEF = new ethers.Contract(York_CHEF_ADDR, York_CHEF_ABI, App.provider);
    
       const startBlock = await York_CHEF.startBlock();
