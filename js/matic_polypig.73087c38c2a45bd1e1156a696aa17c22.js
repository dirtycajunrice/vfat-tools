...
async function main() {
   ...
   const POLYPIG_CHEF_ADDR = "0xfDD6868f652Ded57AA5aB1c7f481CaDDa2a437B6";
   const rewardTokenTicker = "POLYPIG";
   const POLYPIG_CHEF = new ethers.Contract(POLYPIG_CHEF_ADDR, POLYPIG_CHEF_ABI, App.provider);

   const startBlock = await POLYPIG_CHEF.startBlock();
   const currentBlock = await App.provider.getBlockNumber();

   const multiplier = await POLYPIG_CHEF.getMultiplier(currentBlock, currentBlock + 1);
   ...
   if(currentBlock < startBlock){
    ...
    rewardsPerWeek = await POLYPIG_CHEF.polypigPerBlock() /1e18
    ...
    await loadMaticChefContract(App, tokens, prices, POLYPIG_CHEF, POLYPIG_CHEF_ADDR, POLYPIG_CHEF_ABI, rewardTokenTicker,
        "polypig", null, rewardsPerWeek, "pendingPolypig");
