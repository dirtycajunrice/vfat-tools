...
$(function() {
    ...
    async function main() {
       ...
       if(currentBlock < startBlock){
        ...
        rewardsPerWeek = await PICKLE_CHEF.PIcklePerBlock() /1e18
        ...
        await loadMaticChefContract(App, tokens, prices, PICKLE_CHEF, PICKLE_CHEF_ADDR, PICKLE_CHEF_ABI, rewardTokenTicker,
