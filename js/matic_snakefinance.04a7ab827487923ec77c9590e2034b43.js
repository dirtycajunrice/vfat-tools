...
async function main() {
   ...
   const SNAKE_CHEF_ADDR = "0xa74911Fd1c9B1D56f086294d85F315dFf4B82469";
   ...
   const multiplier = await SNAKE_CHEF.getMultiplier(currentBlock, currentBlock + 1);
   ...
   if(currentBlock < startBlock){
    ...
    await loadMaticChefContract(App, tokens, prices, SNAKE_CHEF, SNAKE_CHEF_ADDR, SNAKE_CHEF_ABI, rewardTokenTicker,
        "snake", null, rewardsPerWeek, "pendingSnake");
