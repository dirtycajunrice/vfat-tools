...
async function main() {
   ...
   const NINJA_CHEF_ADDR = "0x2D4EFFc84fABB4AbA0bc16582Cd9931498Af10e4";
   ...
   const multiplier = await NINJA_CHEF.getMultiplier(currentBlock, currentBlock + 1);
   ...
   if(currentBlock < startBlock){
    ...
    rewardsPerWeek = await NINJA_CHEF.ninjaPerBlock() /1e18
    ...
    await loadMaticChefContract(App, tokens, prices, NINJA_CHEF, NINJA_CHEF_ADDR, NINJA_CHEF_ABI, rewardTokenTicker,
        "ninja", null, rewardsPerWeek, "pendingNinja");
