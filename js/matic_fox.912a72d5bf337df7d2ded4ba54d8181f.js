...
async function main() {
   ...
   const FOX_CHEF_ADDR = "0x1AeC80c827F2d35d8EEF2D8D3977516271b05B2e";
   ...
   const multiplier = await FOX_CHEF.getMultiplier(currentBlock, currentBlock + 1);
   ...
   if(currentBlock < startBlock){
    ...
    await loadMaticChefContract(App, tokens, prices, FOX_CHEF, FOX_CHEF_ADDR, FOX_CHEF_ABI, rewardTokenTicker,
