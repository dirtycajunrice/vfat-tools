...
async function main() {
    ...
    const CELLULAR_CHEF_ADDR = "0xDe9a8E2123c55EB44B322F4C9E0CFb3Ea67857CD";
    const rewardTokenTicker = "CELL";
    const CELLULAR_CHEF = new ethers.Contract(CELLULAR_CHEF_ADDR, CELLULAR_CHEF_ABI, App.provider);

    const startBlock = await CELLULAR_CHEF.startBlock();
