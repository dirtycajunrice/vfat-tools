...
async function main() {
    ...
    const SENTIENTSWAP_CHEF_ADDR = "0x5dAAfb8442BC84EC247bCAE77d464438eC8118e6";
    const rewardTokenTicker = "STN";
    const SENTIENTSWAP_CHEF = new ethers.Contract(SENTIENTSWAP_CHEF_ADDR, SENTIENTSWAP_CHEF_ABI, App.provider);

    const startBlock = await SENTIENTSWAP_CHEF.startBlock();
    ...
    if (currentBlock < startBlock) {
        ...
        rewardsPerWeek = await SENTIENTSWAP_CHEF.stnPerBlock() / 1e18 *
            604800 / 2.1;
    }
    ...
    await loadMaticChefContract(App, tokens, prices, SENTIENTSWAP_CHEF, SENTIENTSWAP_CHEF_ADDR, SENTIENTSWAP_CHEF_ABI, rewardTokenTicker,
        "stn", null, rewardsPerWeek, "pendingStn");
