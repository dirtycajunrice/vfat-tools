...
$(function () {
  ...
  async function main() {
      ...
      const PEGASUS_CHEF_ADDR = "0xE6cEd7046bBAA66a0fa82337af06d7993e3abCc0";
      const rewardTokenTicker = "PEGASUS";
      const PEGASUS_CHEF = new ethers.Contract(PEGASUS_CHEF_ADDR, PEGASUS_CHEF_ABI, App.provider);
  
      const startBlock = await PEGASUS_CHEF.startBlock();
      ...
      if (currentBlock < startBlock) {
          ...
          rewardsPerWeek = await PEGASUS_CHEF.pegasusPerBlock() / 1e18 *
              604800 / 2.1;
      }
      ...
      await loadMaticChefContract(App, tokens, prices, PEGASUS_CHEF, PEGASUS_CHEF_ADDR, PEGASUS_CHEF_ABI, rewardTokenTicker,
          "pegasus", null, rewardsPerWeek, "pendingPegasus");
