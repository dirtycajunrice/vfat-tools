...
async function main() {
   ...
   const GOOSE_CHEF_ADDR = "0x4a7E62d5E263F443d0Bdc9d5e298E09713530B66";
   const rewardTokenTicker = "AME";
  ...
  const rewardsPerWeek = rewardPerBlock / 1e18 * multiplier * 604800 / 2
    ...
    await loadHarmonyChefContract(App, tokens, prices, GOOSE_CHEF, GOOSE_CHEF_ADDR, GOOSE_CHEF_ABI, rewardTokenTicker,
        "egg", null, rewardsPerWeek, "pendingEgg", [0,1,2,3,4]);
