...
$(function () {
    ...
    async function main() {
        ...
        const BRSK_CHEF_ADDR = "0x716B3406842143b49AcB16Cdd1b1E43f84BF4d98";
        const rewardTokenTicker = "BRSK";
        const BRSK_CHEF = new ethers.Contract(BRSK_CHEF_ADDR, BRSK_CHEF_ABI, App.provider);
    
        const startBlock = await BRSK_CHEF.startBlock();
        ...
        if (currentBlock < startBlock) {
            ...
            rewardsPerWeek = await BRSK_CHEF.BRSKPerBlock() / 1e18 *
                604800 / 2.1;
        }
        ...
        await loadMaticChefContract(App, tokens, prices, BRSK_CHEF, BRSK_CHEF_ADDR, BRSK_CHEF_ABI, rewardTokenTicker,
            "BRSK", null, rewardsPerWeek, "pendingBRSK");
